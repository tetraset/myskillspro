...
class EnglishEReaderNetParserCommand extends ParserCommand {
    ...
    {
        $this
            ->setName('parser:ebooks')
            ->setDescription('parser for english-e-reader.net')
        ;
    }
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $content = $this->postParse(self::INDEX_PAGE, $output, [
            'author'=>'any',
            'english'=>'any',
            'genre'=>'any',
            'text'=>'any',
            ...
            if ($oldBook !== null) {
                ...
                if(null === $oldBook->getPoster() || strpos($oldBook->getPoster(), 'http') !== false) {
                    ...
                    if(!file_exists($posterFile)) {
                        ...
                        file_put_contents($posterFile, file_get_contents(trim(self::DOMAIN . $matches2['poster'])));
                    }
