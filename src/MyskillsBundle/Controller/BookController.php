...
class BookController extends BaseController
{
    ...
    public function indexAction(Request $request)
    {
        ...
        if( $ajax ) {
            $htmlContent = $this->render('MyskillsBundle:Video:books_list.html.twig', array(
                'books' => $lastData['items'],
                'page' => $page+1,
                'is_more' => $is_more
            ));
        } else {
            $htmlContent = $this->render('MyskillsBundle:Video:index_books.html.twig', array(
                'books' => $lastData['items'],
                'is_more' => $is_more,
                'page' => $page+1,
    ...
    public function showBookAction($code) {
        ...
        $content = $this->render('MyskillsBundle:Video:book.html.twig', [
            'book' => $book,
