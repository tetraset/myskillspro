...
class BingTranslatorService {
    ...
    public function translate( $text, $from='en', $to='ru' ) {
        try {
            ...
            $accessToken  = $authObj->getTokens($this->grantType, $scopeUrl, $this->clientID, $this->clientSecret, $authUrl);
            //Create the authorization Header string.
            $authHeader = "Authorization: Bearer ". $accessToken;

            //Create the Translator Object.
            $translatorObj = new HTTPTranslator();
            $translateMethodUrl = "http://api.microsofttranslator.com/v2/Http.svc/Translate?text=".urlencode($text)."&from=".$from."&to=".$to;
